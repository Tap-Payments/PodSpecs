Pod::Spec.new do |tapVisualEffectView|
    ...
    tapVisualEffectView.version = '1.3.3'
    ...
    tapVisualEffectView.source = { :git => 'https://github.com/Tap-Payments/TapVisualEffectView.git', :tag => tapVisualEffectView.version.to_s }
