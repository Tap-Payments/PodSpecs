Pod::Spec.new do |tapCountriesKitUI|
    ...
    tapCountriesKitUI.pod_target_xcconfig = { 'SWIFT_VERSION' => '4.0' }
    ...
    tapCountriesKitUI.ios.resource_bundle = { 'Resources' => 'TapCountriesKit-UI/Resources/*.{xcassets,storyboard}' }
    
    tapCountriesKitUI.dependency 'SwiftFixes'
