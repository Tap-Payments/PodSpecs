Pod::Spec.new do |editableTextInsetsTextField|
    ...
    editableTextInsetsTextField.pod_target_xcconfig = { 'SWIFT_VERSION' => '4.0' }
    ...
    editableTextInsetsTextField.version = '1.0'
    editableTextInsetsTextField.license = { :type => 'MIT', :file => 'LICENSE' }
    editableTextInsetsTextField.author = { 'Dennis Pashkov' => 'd.pashkov@tap.company' }
    editableTextInsetsTextField.homepage = 'https://github.com/Tap-Payments/EditableTextInsetsTextField'
    editableTextInsetsTextField.source = { :git => 'https://github.com/Tap-Payments/EditableTextInsetsTextField.git', :tag => editableTextInsetsTextField.version.to_s }
